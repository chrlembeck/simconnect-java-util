...
public class UnsubscribeInputEventRequest extends SimRequest {
    ...
    /**
     * Returns the hash ID that will identify the desired input event to unsubscribe from. You can use 0 here to
     * unsubscribe from all input events.
     *
     * @return The hash ID that will identify the desired input event to unsubscribe from.
     */
    public long getHash() {
        return hash;
    }
